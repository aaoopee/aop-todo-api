                    ...
                    try {
                        ...
                        user.findById(tokenData.id).then(function(user) {
                            if (user) {
                                ...
                                console.error('User.classMethods.findByToken: No user found with id')
                                reject();
                            }

                        }, function(e) {
                            console.error('User.classMethods.findByToken: findById failed.')
                            reject();
                        });
                    } catch (e) {
                        console.error('User.classMethods.findByToken '+e);
                        reject();
                    }
                });
            }
